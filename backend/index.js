...
const adminRoute = require("./dRoute/admin.route.js");
const paymentVerificationRoute = require("./dRoute/paymentVerification.route.js");
const receiverAccountRoute = require("./dRoute/receiverAccount.route.js");
// Routes
// index.js or app.js
...
app.use("/api", paymentVerificationRoute); // Payment verification routes
app.use("/api", receiverAccountRoute); // Receiver account routes
