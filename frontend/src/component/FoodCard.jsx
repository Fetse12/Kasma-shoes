            ...
            <div className="bg-white w-48  rounded-2xl shadow-lg relative  flex items-center  ">
                <div>
                    <div className='p-3 px-5'>
                        ...
                        <div className='text-gray-400 text-[12px]'>{data.cal}cal - {data.gram}g</div>

                    </div>
                    <div className='bg-black text-white font-bold text-center w-20 text-xl rounded-tr-2xl rounded-bl-2xl'>25$</div>
                </div>
                <div className='absolute z-20 -right-8'><img className='w-28 h-20 object-scale-down' src={data.img} alt="" /></div>
            </div>
